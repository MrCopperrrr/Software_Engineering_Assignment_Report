...
\definecolor{excelBlue}{RGB}{180, 198, 231}
\definecolor{excelYellow}{RGB}{255, 255, 0}
...
\newpage
\input{Section/4. Triển khai}

\newpage
\input{Section/5. Working Demo}

\newpage
\input{Section/6. KIểm thử.tex}

\newpage
\input{Section/7. DevOps.tex}

\newpage
\input{Section/8. AI Declare.tex}

\newpage
\input{Section/9. Kết luận.tex}
