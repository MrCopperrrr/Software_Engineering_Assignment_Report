...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.5 ]{Picture/ACUC01.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.5 ]{Picture/ACUC04.png}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.4 ]{Picture/SEUC04.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.5 ]{Picture/ACUC05.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.4 ]{Picture/SEUC07.png}
    \caption{Sơ đồ tuần tự Use Case 07: Ghép tự động (Hệ thống đề xuất Tutor)}
    \end{figure}
\end{itemize}
%========================================================================================
\pagebreak
\subsection*{3.1.8. Use Case 08: Thiết lập lịch dạy (Tutor)}
\addcontentsline{toc}{subsection}{3.1.8. Use Case 08: Thiết lập lịch dạy (Tutor)}
Để hệ thống có thể sắp xếp các buổi học, Tutor cần cung cấp thông tin về các khung giờ mình có thể giảng dạy. Chức năng này cho phép Tutor dễ dàng thêm, sửa hoặc xóa thời gian dạy của mình. Dữ liệu này sẽ là nền tảng để sinh viên có thể tìm và đặt lịch học phù hợp.
\begin{itemize}
    \item Sơ đồ hoạt động
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.3 ]{Picture/ACUC08.png}
    \caption{Sơ đồ hoạt động Use Case 08: Thiết lập lịch dạy (Tutor)}
    \end{figure}
    \pagebreak
    \item Sơ đồ tuần tự
    \begin{figure}[H]
    ...
    \caption{Sơ đồ tuần tự Use Case 08: Thiết lập lịch dạy (Tutor)}
    \end{figure}
\end{itemize}
%========================================================================================
\pagebreak
...
\addcontentsline{toc}{subsection}{3.2.3. Giao diện dành cho Tutor}
