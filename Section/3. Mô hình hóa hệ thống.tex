...
\begin{itemize}
    \item Sinh viên chọn chức năng đăng kí môn học, giao diện hiện ra khác môn học khả dụng và và các môn học đã đăng ký.
    \begin{figure}[H]
    \centering
    \setlength{\fboxsep}{2pt}     
    \setlength{\fboxrule}{0.5pt}   
...
\begin{itemize}
    ...
    \caption{Giao diện chi tiết môn học đã đăng kí}
    \end{figure}
\end{itemize}
