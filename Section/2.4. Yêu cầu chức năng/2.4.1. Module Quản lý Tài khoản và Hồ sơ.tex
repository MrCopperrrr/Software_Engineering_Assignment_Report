...
\textbf{Actor chính} &
  \multicolumn{3}{l|}{Sinh viên, Tutor} &
   \\ \cline{1-4}
\textbf{Actor phụ} &
  \multicolumn{3}{l|}{Hệ thống xác thực OTP (Email), Admin PĐT} &
   \\ \cline{1-4}
...
\multirow{10}{*}{\textbf{Luồng sự kiện}} &
 ...
 &
  \multicolumn{1}{l|}{4} &
  \multicolumn{1}{l|}{Hệ thống} &
  \begin{tabular}[c]{@{}l@{}}Kiểm tra trùng MSSV/email. \\ Nếu trùng → báo lỗi, dừng quy trình.\end{tabular} &
   \\ \cline{2-4}
 &
  \multicolumn{1}{l|}{5} &
  \multicolumn{1}{l|}{Hệ thống} &
...
\multirow{4}{*}{\textbf{Luồng thay thế}} &
 ...
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Phát hiện MSSV/email đã tồn tại → hiển thị \\ “Tài khoản đã có”.\end{tabular} &
   \\ \cline{1-4}
\textbf{Ngoại lệ} &
  \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}Hệ thống không gửi được OTP (lỗi server/email) \\ → hiển thị “Vui lòng thử lại sau”. \\ Hệ thống lỗi khi lưu dữ liệu vào DB \\ → rollback, hiển thị “Thao tác thất bại”.\end{tabular}} &
   \\ \cline{1-4}
