...
Tutor có thể là sinh viên giỏi, NCS, hoặc giảng viên, được đăng ký vào hệ thống để hỗ trợ học tập. Họ có trách nhiệm quản lý hồ sơ, lịch dạy, tổ chức buổi học và theo dõi tiến độ của sinh viên.
\begin{itemize}
    \item \textbf{Tạo và cập nhật lịch dạy:}
    \begin{itemize}
        \item \textbf{Input:} Ngày, giờ, hình thức học (online/offline).
        \item \textbf{Process:} Hệ thống lưu lại khung giờ dạy, đồng bộ với module đặt lịch.
        \item \textbf{Output:} Lịch dạy hiển thị cho sinh viên để chọn.
        \item \textbf{Constraints:} Không được nhập trùng khung giờ.
        \item \textbf{Acceptance:} Sinh viên có thể đặt lịch học trong khung dạy của Tutor.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Tự động: } Hệ thống so khớp theo khoa/ngành, lịch dạy, AI ranking.
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Process:} Hệ thống kiểm tra lịch dạy của Tutor và lịch của SV.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Input:} Hồ sơ cá nhân, chuyên môn, lịch dạy của Tutor.
    ...
    \begin{itemize}
        ...
        \item \textbf{Process:} Hệ thống gợi ý phân bổ Tutor cho SV (theo ngành, lịch dạy, số lượng tối đa).
...
\begin{figure}[H]
    \centering
    % \includegraphics[scale=0.4]{Picture/CNPM_Usecase-diagram.drawio.png}
    \includegraphics[scale=0.7 ]{Picture/Usecase-diagram.png}
    \caption{Sơ đồ Usecase toàn hệ thống}
\end{figure}
%========================================================================================
...
\subsubsection*{US-08: Thiết lập lịch dạy (Tutor)} 
Là tutor, tôi muốn thiết lập lịch dạy để sinh viên có thể xem, sắp xếp và đăng ký.
...
\input{Section/2.4. Yêu cầu chức năng/2.4.1. Module Quản lý Tài khoản và Hồ sơ.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.2. Module Đăng ký chương trình học.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.3. Module Ghép cặp Tutor – SV.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.4. Module Quản lý lịch học.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.5. Module Thông báo và nhắc nhở.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.6. Module Quản lý buổi học và điểm danh.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.7. Module Quản lý tài liệu học tập.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.8. Module Đánh giá và phản hồi.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.9. Module Thống kê và báo cáo.tex}
...
\input{Section/2.4. Yêu cầu chức năng/2.4.10. Module Chương trình học thuật và phi học thuật.tex}
...
\begin{itemize}
    ...
    \item \textbf{Constraints:}
    \begin{itemize}
        \item Database: MySQL (Sử dụng thư viện mysql2 pool).
        \item Backend: Node.js sử dụng framework Express.
        \item Frontend: ReactJS (Build tool Vite, Styling TailwindCSS).
