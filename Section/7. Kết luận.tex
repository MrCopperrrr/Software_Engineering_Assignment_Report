\part*{Phần 7: Kết luận}
\addcontentsline{toc}{part}{Phần 7: Kết luận}
...
\section*{7.1. Kết quả đạt được}
\addcontentsline{toc}{section}{7.1. Kết quả đạt được}
...
\section*{7.2. Bài học kinh nghiệm}
\addcontentsline{toc}{section}{7.2. Bài học kinh nghiệm}
...
\begin{itemize}
    ...
    \item Thách thức trong việc tích hợp hệ thống: Việc phải thiết kế để tích hợp với các hệ thống có sẵn của nhà trường (HCMUT\_SSO, DATACORE) đòi hỏi nhóm phải suy nghĩ cẩn thận về các vấn đề bảo mật, đồng bộ dữ liệu và các giao thức giao tiếp API.
\end{itemize}


\section*{7.3. Hướng phát triển trong tương lai}
\addcontentsline{toc}{section}{7.3. Hướng phát triển trong tương lai}
